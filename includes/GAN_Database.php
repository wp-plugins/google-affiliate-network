...
class GAN_Database {
  ...
  static function make_ad_table() {
    ...
    $sql = "CREATE TABLE ".GAN_AD_TABLE." (
	  ...
	  EndDate date NOT NULL default '2037-12-31',
	  ClickserverLink varchar(1024) NOT NULL default '',
	  ImageURL varchar(1024) default '',
	  ImageHeight int default 0,
	  ImageWidth int default 0,
	  LinkURL varchar(1024) NOT NULL default '',
	  PromoType varchar(32) NOT NULL default '',
	  MerchantID varchar(16) NOT NULL default '',
	  enabled boolean NOT NULL,
	  LastRunDate date default '1970-01-01',
