...
class GAN_Plugin {
	...
	function admin_configure_options() {
	  ...
	  } else if ( isset($_REQUEST['forceupdatedb']) ) {
	    GAN_Database::upgrade_database(true);
	    ?><div id="message"class="updated fade"><p><?php _e('Database Upgraded','gan'); ?></p></div><?php
	  }
	  /* Head of page, filter and screen options. */
	  ...
	  ?><div class="wrap"><?php $this->admin_tabs('gan-database-options'); ?><br clear="all" />
		...
		} ?><p><input type="submit" name="displaydatabasetab" class="button-primary" value="<?php _e('Display Database','gan'); ?>"></p>
		    <p><input type="submit" name="forceupdatedb" class="button-primary" value="<?php _e('Force update Database','gan'); ?>"></p></form></div><?php
	}
	function admin_help() {
	...
	function add_media_button() {
	  ...
	  echo '<a href="'.$url.'" class="button insert-gan add_gan thickbox" title="'.
			__('Add Ad Unit','gan').'"><span class="wp-media-buttons-icon"></span>Add GAN Ad Unit</a>';
